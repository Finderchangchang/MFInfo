...
public class RomUtil {
    ...
    public static String putCache(String key,String val) {
        SharedPreferences sp = App.Companion.getContext().getSharedPreferences("waichangepwd",
    ...
    public static String getCache(String key) {
        SharedPreferences sharedPreferences = App.Companion.getContext().getSharedPreferences("waichangepwd", Context.MODE_PRIVATE);
