...
public class ResourceUtils {
    ...
    public static int getDimenValues(Context context, int id) {
        return (int) context.getResources().getDimension(id);
    }

    public static int getColor(Context context, int id) {
        return (int)context.getResources().getColor(id);
    }

    public static float getColor3(Context context, int id) {
        return 0;
    }
    ...
    public static int dip2px2(Context context, int id) {
        float dimenValues = getDimenValues(context, id);

        final float scale = context.getResources().getDisplayMetrics().density;
        return (int) (dimenValues * scale + 0.5f);
    }
    ...
    public static String[] getAssetsFileNameList(Context context, String path) {
        String fileNames[] = null;
        try {
            fileNames = context.getAssets().list(path);//获取assets目录下的所有文件及目录名
        } catch (IOException e) {
            e.printStackTrace();
        }
        return fileNames;
    ...
    public static InputStream openAssetsFile(Context context, String path) {
