...
public class StringUtils {
    public static final String LineLeed = "\r\n";
    ...
    public static String runcation(String s) {

        return s.substring(0, s.length() - 1);
    }

    public static String parse(String value, String defaultValue) {
        return parse(value, "", defaultValue);
    }

    public static String parse(String value, String unit, String defaultValue) {
        if (isEmpty(value)) {
            return defaultValue;
        }
        return value + unit;
    ...
    public static boolean ObjectIsSame(InputStream fis1, InputStream fis2) {
        if (fis1 == null && fis2 == null) {
            return true;
        } else if (fis1 != null && fis2 != null) {
            try {
                fis1.reset();
            } catch (IOException e) {
                e.printStackTrace();
